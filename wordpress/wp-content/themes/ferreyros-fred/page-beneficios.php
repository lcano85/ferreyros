<?php
get_header();
/* Template Name: Página Beneficios */
global $post; 
...
if( permissions_content($permisos_contenido) == 'true' ): ?>
    ...
    <?php if (have_posts()) : ?>
    <section class="ferreyros__page--content ferreyros__page--<?php echo $post_slug = $post->post_name; ?> pt-5 pb-4">
        <div class="container">
    ...
    <section class="ferreyros__page--content fred__page--<?php echo $post_slug = $post->post_name; ?> pb-5">
        <div class="container">
