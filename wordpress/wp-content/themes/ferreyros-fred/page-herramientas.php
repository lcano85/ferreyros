...
/* Template Name: Página Herramientas */
...
if( permissions_content($permisos_contenido) == 'true' ): ?>
    ...
    <?php if(get_field('contenido_principal')): ?>
    <section class="ferreyros__page--content fred__page--<?php echo $post_slug = $post->post_name; ?>-1 pt-5">
        <div class="container">
            <?php echo get_field('contenido_principal'); ?>
        </div>
    </section>
    <?php endif; ?>
    ...
    <?php 
        ...
        $rows = get_field('portales'); 
        if( $rows ) :
    ?>
    <section class="ferreyros__page--content fred__page--<?php echo $post_slug = $post->post_name; ?>-2 pt-4">
        <div class="container">
            <div class="row">
    ...
    <?php if(get_field('contenido_final')): ?>
    <section class="ferreyros__page--content fred__page--<?php echo $post_slug = $post->post_name; ?>-4 py-5">
        <div class="container">
            <?php echo get_field('contenido_final'); ?>
        </div>
    </section>
    <?php endif; ?>
    ...
    <?php 
        ...
        if( $rows ) :
    ?>
    <section class="ferreyros__page--content fred__page--<?php echo $post_slug = $post->post_name; ?>-3 pb-5">
        <div class="container">
            <?php if(get_field('accesos_directos')): ?>
            <div class="fred__page--header pb-4">
                <h2 class="text-center m-0"><?php echo get_field('titulo_seccion_accesos_directos') ?></h2>
            </div>
            <?php endif; ?>
            <?php $rows = get_field('accesos_directos'); ?>
            <div class="fred__page--content">
                        ...
                        <div class="ferreyros__card --mod3">
                            ...
                            <div class="card__content">
                                <?php if($row['tipo_accesos_directos'] == 'interno'):
                                        $page = $row['acceso_directo_interno'];
                                    ?>
                                    <h2 class="title"> <a class="permalink" href="<?php echo get_the_permalink( $page->ID ); ?>"><?php echo get_the_title( $page->ID ); ?></a></h2>
                                <?php elseif($row['tipo_accesos_directos'] == 'externo'): ?>
