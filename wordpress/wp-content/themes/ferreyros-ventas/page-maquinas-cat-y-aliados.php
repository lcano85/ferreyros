...
if( permissions_content($permisos_contenido) == 'true' ): ?>
    ...
    <?php $promociones = get_field('seccion_promociones'); ?>
    <section class="ventas__page--maquinarias-promociones">
        <div class="container">
            <div class="row justify-content-center">
                <?php if($promociones['embebido']): ?>
                    <div class="col-sm-12 col-md-auto">
                        <?php echo $promociones['embebido']; ?>
                    </div>
                <?php endif; ?>
                <?php if($promociones['banner_promocional']): ?>
                    <div class="col-sm-12 col-md-auto text-center pb-4">
                        <a href="<?php echo $promociones['enlace_promocional']; ?>">
                            <img src="<?php echo $promociones['banner_promocional']['url']; ?>" alt="<?php echo $promociones['banner_promocional']['alt']; ?>">
                        </a>
                    </div>
                <?php endif; ?>
                <?php if($promociones['banner_promocional_2']): ?>
                    <div class="col-sm-12 col-md-auto text-center">
                        <a href="<?php echo $promociones['enlace_promocional_2']; ?>">
                            <img src="<?php echo $promociones['banner_promocional_2']['url']; ?>" alt="<?php echo $promociones['banner_promocional_2']['alt']; ?>">
                        </a>
                    </div>
                <?php endif; ?>
            </div>
    ...
    <section class="ferreyros__page--content ventas__page--maquinarias-accesos">
        <div class="container">
