...
<head>
	...
	<script async src="https://www.googletagmanager.com/gtag/js?id=<?php echo GA_ID_VENTAS; ?>"></script>
	<script>
	  window.dataLayer = window.dataLayer || [];
	  function gtag(){dataLayer.push(arguments);}
	  gtag('js', new Date());

	  gtag('config', '<?php echo GA_ID_VENTAS; ?>');
	</script>
</head>
...
<body <?php body_class(); ?> id="portal-ventas">