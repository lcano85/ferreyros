...
/* Template Name: Pagina con Entradas y Accesos*/
            ...
            <div class="row">
                <div class="col-sm-12 col-md-9">
                    <div class="ferreyros__section mb-5">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h2 class="m-0"><?php echo $titulo_seccion; ?></h2>
                            </div>
                        </div>
                        <?php endif; ?>
                    <?php                             
                    ...
                    <?php 
                    $rows = get_field('accesos_directos_horizontales'); 
                        if( $rows ) :
                    ?>
                    <div class="ferreyros__section my-5">
                ...
                <div class="col-sm-12 col-md-3 ps-4">
                <?php if (have_posts()) :
                    while (have_posts()) : ?>
                    <div class="row">
                        <div class="col-sm-12">
